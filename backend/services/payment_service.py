...
class PaymentService:
    ...
    async def validate_card(
        ...
        # Validación de tarjeta: el flujo productivo de inscripción/cobro usa OneClick en routes/oneclick y payment_intent.
        # Guardar validación
            ...
            try:
                ...
                if approved:
                    ...
                    return {
                        'success': False,
                        'status': 'failed',
                        'message': f'Transbank rechazó el cobro: response_code={rc} status={st!r}',
                        'error': 'TBK_AUTHORIZE_FAILED',
                        'tbk_response_code': rc,
                        'tbk_detail': d0,
                    }
            except Exception as e:
                ...
                return {
                    'success': False,
                    'status': 'failed',
                    'message': f'Error al procesar el pago: {str(e)[:200]}',
                    'error': str(e)
                }
        else:
