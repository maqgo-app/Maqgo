        ...
        <div style={{
          ...
          {reservationType === 'today' ? (
            <p style={{ color: 'rgba(255,255,255,0.95)', fontSize: 13, margin: 0, lineHeight: 1.5 }}>
              <strong style={{ color: '#fff' }}>Reserva para Hoy</strong>: antes de la aceptación = 0% · después de la aceptación = 20% · autorizar ingreso = 100% · servicio iniciado = 100%. Si se supera el límite máximo absoluto de atraso (4 horas), puedes cancelar sin costo. Este límite no cambia por nuevas ETA y MAQGO puede intentar reasignar el servicio.
            </p>
          ) : reservationType === 'scheduled' ? (
            <p style={{ color: 'rgba(255,255,255,0.95)', fontSize: 13, margin: 0, lineHeight: 1.5 }}>
              <strong style={{ color: '#fff' }}>Reserva Programada</strong>: &gt;48h = 0% · 48–24h = 10% · 24h o menos = 20% · autorizar ingreso = 100% · servicio iniciado = 100%.
            </p>
          ) : (
