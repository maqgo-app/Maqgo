      ...
      >
        ...
        {uxCaluga ? (
          <div style={{ display: 'flex', justifyContent: 'center', marginBottom: 10, flexShrink: 0 }}>
            <span className="maqgo-orange-hint-pill">Elige maquinaria y te mostramos proveedores disponibles cerca</span>
          </div>
        ) : null}
        ...
        {uxCaluga ? (
          <p style={{ color: 'rgba(255,255,255,0.82)', fontSize: 14, textAlign: 'center', marginBottom: 8, lineHeight: 1.4 }}>
