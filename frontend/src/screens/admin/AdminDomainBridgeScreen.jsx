  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
      ...
      <AdminSurface
        ...
        subtitle="Resumen del avance y del alcance disponible hoy para esta area."
      >
        <div style={{ display: 'flex', gap: 12, flexWrap: 'wrap' }}>
          <AdminStatChip label="Area activa" value="Si" tone="success" />
          <AdminStatChip label="Estado actual" value={meta.actions?.length ? 'Operable' : 'En preparacion'} tone="warning" />
      ...
      <AdminSurface
        ...
        subtitle="Entradas que hoy ya puedes usar para operar esta area."
      >
        {meta.actions?.length ? (
          ...
          >
            Esta area ya tiene su lugar dentro del Admin. La siguiente etapa es completar herramientas y flujos sin
