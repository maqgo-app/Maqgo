...
function ProviderHistoryScreen() {
  ...
  return (
    <div style={{ background: '#1a1a1a', minHeight: '100vh' }}>
      <div style={{ maxWidth: 500, margin: '0 auto', padding: 24, paddingBottom: 100 }}>
        ...
        <div style={{ 
          ...
          >
            ...
            <div style={{ fontSize: 10, opacity: 0.8 }}>({pendingServices.length})</div>
          </button>
          ...
          >
            ...
            <div style={{ fontSize: 10, opacity: 0.8 }}>({paidServices.length})</div>
          </button>
        </div>
          ...
          <div>
            ...
            {pendingServices.length === 0 && (
              <div style={{ textAlign: 'center', padding: 40 }}>
                ...
                <button type="button" className="maqgo-btn-secondary" onClick={() => navigate('/provider/home')} style={{ maxWidth: 280, margin: '0 auto' }}>
                  Volver al inicio
                </button>
              </div>
            )}
