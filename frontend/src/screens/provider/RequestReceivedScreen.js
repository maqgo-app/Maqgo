...
function RequestReceivedScreen() {
  ...
  const handleAccept = async () => {
    ...
    setLoading(true);
    try {
      // Guardar datos de la solicitud aceptada
  ...
  const homeRoute = isOperator ? '/operator/home' : '/provider/home';
    ...
    <div className="maqgo-app">
      <div className="maqgo-screen" style={{ padding: '25px 20px', overflowY: 'auto' }}>
        ...
        <div style={{
          ...
          <div style={{ fontSize: 11, color: 'rgba(255,255,255,0.95)', textTransform: 'uppercase', marginBottom: 10, fontWeight: 600 }}>
            Detalles
          </div>
          ...
          <div style={{ display: 'flex', gap: 12, marginTop: 12, paddingTop: 10, borderTop: '1px solid #444' }}>
            <div style={{ flex: 1, background: '#2D2D2D', borderRadius: 8, padding: '8px 10px', textAlign: 'center' }}>
              <div style={{ color: 'rgba(255,255,255,0.95)', fontSize: 10 }}>Distancia</div>
              <div style={{ color: '#fff', fontSize: 14, fontWeight: 600 }}>{request?.distance || 5} km</div>
            </div>
            <div style={{ flex: 1, background: '#2D2D2D', borderRadius: 8, padding: '8px 10px', textAlign: 'center' }}>
              <div style={{ color: 'rgba(255,255,255,0.95)', fontSize: 10 }}>Llegar en</div>
