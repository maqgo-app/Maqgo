...
/**
 * Pantalla de verificación Proveedor - WhatsApp por defecto, SMS como backup
 */
function ProviderSelectChannelScreen() {
    ...
    <div className="maqgo-app">
      <div className="maqgo-screen">
        ...
        <div style={{ flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
          ...
          <p style={{ color: 'rgba(255,255,255,0.8)', fontSize: 14, textAlign: 'center', marginBottom: 12 }}>
            Llegará en unos segundos a tu celular.
          </p>
          <p style={{
            color: '#EC6819',
            fontSize: 18,
          ...
          <button
            ...
            data-testid="provider-send-sms-btn"
          >
            {loading ? (
...
export default ProviderSelectChannelScreen;
