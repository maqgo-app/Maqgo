...
/** Celular chileno nacional: 9 dígitos empezando por 9 (sin +56). */
function buildCelularNational(nineDigits) {
...
function ForgotPasswordScreen() {
  ...
  return (
    <div className="maqgo-app maqgo-client-funnel" style={{ display: 'flex', flexDirection: 'column' }}>
      <div
        ...
        {step === 1 ? (
          <>
            ...
            <PhoneNationalInput
              ...
              onDigitsChange={setPhoneLocalDigits}
