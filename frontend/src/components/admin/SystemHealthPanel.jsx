    ...
    >
      ...
      >
        {[
          ...
          >
            <p style={{ color: 'rgba(255,255,255,0.5)', fontSize: 12, margin: '0 0 8px', textTransform: 'uppercase' }}>{block.label}</p>
      ...
      {detailOpen && (
        <>
          ...
          <div style={{ marginTop: 8, paddingTop: 14, borderTop: '1px solid rgba(255,255,255,0.08)' }}>
            <p style={{ color: '#EC6819', fontSize: 13, fontWeight: 700, margin: '0 0 8px', textTransform: 'uppercase' }}>Acciones sugeridas</p>
