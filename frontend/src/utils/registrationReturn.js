...
import { traceRedirectToLogin } from './traceLoginRedirect';
...
export function navigateToRegister(navigate, returnPath) {
  ...
  traceRedirectToLogin('src/utils/registrationReturn.js (navigateToRegister)');
  navigate('/login');
}
...
export function navigateToLogin(navigate, returnPath) {
  saveReturnUrl(returnPath);
  traceRedirectToLogin('src/utils/registrationReturn.js (navigateToLogin)');
  navigate('/login');
}
